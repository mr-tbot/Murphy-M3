...
## Repo layout
- `backup/stock-firmware/` — full 16MB stock flash dump + extracted partitions. NEVER delete;
...
- Full restore: `esptool --port /dev/ttyACM0 write-flash 0x0 backup/stock-firmware/murphy-m3-full-flash-16MB.bin`
